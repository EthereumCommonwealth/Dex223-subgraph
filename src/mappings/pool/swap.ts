...
import { STABLECOIN_IS_TOKEN0, USDC_WETH_03_POOL, WETH_ADDRESS, WHITELIST_TOKENS } from '../../utils/constants'
...
export function handleSwapHelper(
  ...
  if (token0 && token1) {
    ...
    // interval data
    const dex223DayData = updateDex223DayData(event)
    ...
    dex223DayData.volumeETH = dex223DayData.volumeETH.plus(amountTotalETHTracked)
    dex223DayData.volumeUSD = dex223DayData.volumeUSD.plus(amountTotalUSDTracked)
