...
describe('handleSwap', () => {
  beforeAll(() => {
    ...
    const usdcEntity = Token.load(USDC_MAINNET_FIXTURE.addressERC20)!
    usdcEntity.derivedETH = TEST_USDC_DERIVED_ETH
    usdcEntity.save()

    const wethEntity = Token.load(WETH_MAINNET_FIXTURE.addressERC20)!
  ...
  test('success', () => {
    ...
    const wrappedNativeAddress = WETH_MAINNET_FIXTURE.addressERC20
    const stablecoinAddresses = [USDC_MAINNET_FIXTURE.addressERC20]
    const minimumEthLocked = ZERO_BD
    const whitelistTokens = [USDC_MAINNET_FIXTURE.addressERC20, WETH_MAINNET_FIXTURE.addressERC20]

    const token0 = Token.load(USDC_MAINNET_FIXTURE.addressERC20)!
    const token1 = Token.load(WETH_MAINNET_FIXTURE.addressERC20)!
    ...
    assertObjectMatches('Dex223DayData', dayId.toString(), [
    ...
    assertObjectMatches('TokenDayData', USDC_MAINNET_FIXTURE.addressERC20 + '-' + dayId.toString(), [
      ['volume', amount0Abs.toString()],
      ['volumeUSD', amountTotalUSDTracked.toString()],
    ...
    assertObjectMatches('TokenDayData', WETH_MAINNET_FIXTURE.addressERC20 + '-' + dayId.toString(), [
      ['volume', amount1Abs.toString()],
      ['volumeUSD', amountTotalUSDTracked.toString()],
      ['untrackedVolumeUSD', amountTotalUSDTracked.toString()],
      ['feesUSD', feesUSD.toString()]
    ...
    assertObjectMatches('TokenHourData', USDC_MAINNET_FIXTURE.addressERC20 + '-' + hourId.toString(), [
      ['volume', amount0Abs.toString()],
      ['volumeUSD', amountTotalUSDTracked.toString()],
      ['untrackedVolumeUSD', amountTotalUSDTracked.toString()],
      ['feesUSD', feesUSD.toString()]
    ...
    assertObjectMatches('TokenHourData', WETH_MAINNET_FIXTURE.addressERC20 + '-' + hourId.toString(), [
      ['volume', amount1Abs.toString()],
      ['volumeUSD', amountTotalUSDTracked.toString()],
      ['untrackedVolumeUSD', amountTotalUSDTracked.toString()],
      ['feesUSD', feesUSD.toString()]
